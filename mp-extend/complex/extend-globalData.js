...
/**
 * 将app.globalData.public注入到所有页面的data.$globalData中
 * 并提供this.$globalSetData的方法修改 globalData.public
 */
...
export default {
  ...
  Page: {
    onLoad() {
      appInstance.globalData.public = appInstance.globalData.public || {}
      this.setData({
        $globalData: appInstance.globalData.public
      })
